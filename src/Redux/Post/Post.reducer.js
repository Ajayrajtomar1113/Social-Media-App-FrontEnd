import { CREATE_POST_FAILURE, CREATE_POST_SUCCESS, CREATE_POST_REQUEST, GET_ALL_POST_REQUEST, LIKE_POST_SUCCESS, GET_ALL_POST_FAILURE, LIKE_POST_FAILURE, GET_ALL_POST_SUCCESS, LIKE_POST_REQUEST, CREATE_COMMENT_SUCCESS, CREATE_REEL_REQUEST, CREATE_REEL_SUCCESS, CREATE_REEL_FAILURE, GET_ALL_REEL_SUCCESS, GET_ALL_REEL_REQUEST, GET_ALL_REEL_FAILURE, DELETE_COMMENT_REQUEST, DELETE_COMMENT_SUCCESS, DELETE_POST_REQUEST, DELETE_POST_SUCCESS , DELETE_REEL_SUCCESS, DELETE_REEL_FAILURE, DELETE_REEL_REQUEST  } from "./Post.actionType";
...
export const postReducer = (state = initialState,action)=>{
    switch (action.type) {
        ...
        case DELETE_REEL_SUCCESS:
            return {
                ...state,
                reels: state.reels.filter(r => r.id !== action.payload)
            };
        ...
        case GET_ALL_REEL_SUCCESS:
            return {
                ...state,
                reels: Array.isArray(action.payload)
                    ? action.payload
                    : action.payload?.data || [],
                loading:false,
                error:null
